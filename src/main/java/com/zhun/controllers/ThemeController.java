...
public class ThemeController {
    ...
    public void initialize() throws IOException {
        ...
        // Load images
        images.add(new Image("/images/retroPreview.jpg"));
        images.add(new Image("/images/neonPreview.jpg"));
        images.add(new Image("/images/candyPreview.jpg"));
    ...
    private void setTheme() {
        switch (currentIndex) { // Update css stylesheet
            case 0 -> SceneManager.setTheme("retro");
            case 1 -> SceneManager.setTheme("neon");
            case 2 -> SceneManager.setTheme("candy");
        }
    }
